...
//        }
    ...
    public void delete() {
        if(this.selectedEvent != null) {
            Messagebox.show("¿Desea elimimar " + selectedEvent.getNombre() + " ?", "Advertencia", Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, 
             ...
             Messagebox.show("Seleccione una Mascota", "Advertencia", Messagebox.OK, Messagebox.INFORMATION);
    }
    ...
    {
        if(mascotas == null) {
            mascotas = new ListModelList<>();//new ListModelList<Mascota>(getEvents()); //Para mostrar todo
        }
    ...
    public void showHistorial()
    {
        ...
        Executions.createComponents("/mascotas/mascota-historial.zul", center, map);
    }
