...
public class ProveedorDAO extends ManagerConexion{	
	...
	public List<Proveedor> findAll() {
            ...
            return findAll("select * from zk_proveedor");/*
		...
		List<Proveedor> allEvents = new ArrayList<>();
		try {
			// get connection
		    Statement stmt = getStatement();
