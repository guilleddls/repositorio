...
public class EstadisticosMascVM {
    ...
    List<EstadisticosMasc> events = new ArrayList<>();
    List<EstadisticosMonetario> ingresos = new ArrayList<>();
    private final EstadisticosMascDAO eventDao = new EstadisticosMascDAO();
