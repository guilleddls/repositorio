...
//    private Font subFont = new Font(Font.FontFamily.TIMES_ROMAN, 16, Font.BOLD);
    ...
    public void createPdf(){
        try {
                ...
                PdfWriter docWriter = PdfWriter.getInstance(document, new FileOutputStream(sfactura));
                document.open();
                ...
                new FacturaDAO().updatePDF(factura);
    ...
    private void addLogo(Document doc) throws DocumentException, Exception{
        try {
            String logo = Executions.getCurrent().getDesktop().getWebApp().getRealPath("/logoUTN.png");
//            String logo2 = Executions.getCurrent().getDesktop().getWebApp().getRealPath("../logoUTN.png");
//            String logo3 = Executions.getCurrent().getDesktop().getWebApp().getRealPath("../../logoUTN.png");
//            String logo4 = Executions.getCurrent().getDesktop().getWebApp().getRealPath("../veterinaria/logoUTN.png");
//            String logo = Executions.getCurrent().getDesktop().getWebApp().getRealPath("logoUTN.png");
            if(logo == null) logo = Executions.getCurrent().getDesktop().getWebApp().getRealPath("logoUTN.png") ;
  ...
  // under File -> Properties
    private void addMetaData(Document document) {
        ...
        document.addAuthor("guillermodiyenno@gmail.com");
        document.addCreator("guillermodiyenno@gmail.com");
    }
...
//                                "\nCUIT: " + factura.getCliente().getNif() +
...
//        preface.setAlignment(Element.ALIGN_LEFT);
    ...
    public PdfPTable createTable() throws DocumentException {
        ...
        {
            List<VentaLinea> listVenta = venta.getVenta_lineas();
    ...
    //                    System.out.println("IVA: " +iva2);
        ...
        //                System.out.println("!null:" + descripcion);
            ...
            //                System.out.println("!null:" + descripcion);
                ...
                cell = new PdfPCell(new Phrase("$ "+deciFormat.format(vlinea.getPvp()) , small));
                cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
                cell.setPaddingBottom(5);
                table.addCell(cell);

                cell = new PdfPCell(new Phrase("$ "+deciFormat.format(vlinea.getMonto()), small));
                cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
                cell.setPaddingBottom(5);
                table.addCell(cell);
            }
        ...
        cell = new PdfPCell(new Phrase("$ "+deciFormat.format(factura.getCoste()) , smallBold));
        cell.setColspan(1);
        cell.setHorizontalAlignment (Element.ALIGN_RIGHT);
        cell.setPaddingBottom(5);
        table.addCell(cell);
        ...
        cell = new PdfPCell(new Phrase("$ "+deciFormat.format(factura.getIvas()) , smallBold));
        cell.setColspan(1);
        cell.setHorizontalAlignment (Element.ALIGN_RIGHT);
        cell.setPaddingBottom(5);
        table.addCell(cell);
        ...
        cell = new PdfPCell(new Phrase("$ "+deciFormat.format(costetotal), smallBold));
        cell.setColspan(1);
        cell.setHorizontalAlignment (Element.ALIGN_RIGHT);
        cell.setPaddingBottom(5);
        table.addCell(cell);
    ...
    private void generateHeader(Document doc, PdfContentByte cb) {
        try {
            ...
            createHeadings(cb, 150, 760, "CUIT: 11-111111-1", 8);
            createHeadings(cb, 150, 745, "Dirección, 1", 8);
            createHeadings(cb, 150, 730, "Localidad - (Provincia)", 8);
            createHeadings(cb, 150, 715, "Teléfono: 0341 456789", 8);
...
//            cb.setGrayStroke(20f);
            ...
            createCliente(cb, 35, 626, "CUIT:    " + factura.getCliente().getNif(), 11);
