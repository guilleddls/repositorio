...
.z-tabbox .z-tabs-content {
  border-bottom-color: #084ec7;
...
.z-tabbox .z-tab:focus,
.z-tabbox .z-tab:active {
...
border-left-color: #4C8FBD;
border-right-color: #4C8FBD;
  border-style: solid;
}
.z-tabbox .z-tab-selected .z-tab-text {
  font-weight: normal;
}
.z-tabbox .z-tabpanel {
    border: 0;
...
.z-tabbox .z-tab:first-child.z-tab-selected + .z-tab {
   ${ t:boxShadow('none') };
}
...
.z-selectbox:focus,
 ...
 .z-intbox:focus,
 .z-textbox:focus {
  -webkit-box-shadow: 0 1px 1px #719ece inset, 0 0 10px #719ece;
  box-shadow: 0 1px 1px #719ece inset, 0 0 10px #719ece;
  color: #070707;
  border-color: #4245f5;
  outline: none;
}
